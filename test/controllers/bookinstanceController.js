...
exports.bookinstance_delete_post = asyncHandler(async (req, res, next) => {
  ...
  if (bookInstance === null) {
    // No results. Redirect to the list of book instances.
    res.redirect('/catalog/bookinstances');
  } else {
    // BookInstance found. Delete object and redirect to the list of book instances.
...
exports.bookinstance_update_get = asyncHandler(async (req, res, next) => {
  ...
  res.render('bookinstance_update', { title: 'Update Book Copy', bookinstance });
});
